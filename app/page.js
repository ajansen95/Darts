...
export const socket = io('http://192.168.178.75:5000');
        ...
        <main className="flex flex-col h-screen">
            <nav className="h-10 bg-gray-900">
                <div className="w-full h-full flex justify-end items-center p-3">
                    <button onClick={() => {dispatch(toggleSettingsOpen())}}>
            ...
            <div className="bg-gray-700 flex items-center justify-center flex-1">
                ...
                <div id="rightSpacing" className="flex-1 h-full">
                    <div id="rightMenu" className="flex flex-col w-2/5 h-full bg-gray-900 ml-auto">
